...
<template>
  <div class="relative">
    ...
    <div class="flex items-end justify-end">
      ...
      <UButton color="white" class="m-1" icon="i-arrow-long-left-16-solid"
               @click="handleButtonClick('一起探索节气生长的力量，请画出关于枝繁叶茂的夏天风景画！')">
        假如你是一位画家，探索节气生长的力量，请画出“夏天的繁茂”！
      </UButton>
    </div>
    <div class="flex items-end justify-end">
      <UButton color="white" class="m-1" icon="i-arrow-long-left-16-solid"
               @click="handleButtonClick('一起探索节气生长的力量，请画出关于一副硕果累累收获的秋天风景画！')">
        假如你是一位画家，探索节气生长的力量，请画出“秋天的收获”！
      </UButton>
       <UButton color="white" class="m-1" icon="i-arrow-long-left-16-solid"
               @click="handleButtonClick('一起探索节气生长的力量，请画出一副万物休眠冬季风景画！')">
